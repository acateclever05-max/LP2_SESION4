...
public class FrmManteProd extends JFrame {
	...
	void registrar() {
		...
		try {
			...
			if(proveedor == null) {
				JOptionPane.showMessageDialog(null, "Selecionar provedor");
				return;
			}
	...
	void listado() {
		...
		for(Producto item : lista) {
			...
			txtSalida.append("Categoria: "+ item.getCategoria().getIdCategoria()+"-"+ item.getCategoria().getDescripcion()+"\n");
			txtSalida.append("Proveedor: "+ item.getProveedor().getIdProveedor()+"-"+ item.getProveedor().getNombreRs()+"\n");
			txtSalida.append("*****************************************\n");
		}
	}
